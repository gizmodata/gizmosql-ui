...
### Changed
- Bumped `@gizmodata/gizmosql-client` to ^2.0.1, which bundles the
  `gizmosql-adbc` v2.0.8 native driver — fixes geometry-aware bulk ingest
  against GizmoSQL ≥ 1.37.0 (server-side `GEOMETRY` columns).
